...
// Import projects data (adjust the path if needed)
import { projects } from '../data/projects'; // Changed relative path.  Make sure this is correct!
...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    const selectedProject = projects.find((p) => String(p.id) === id); // Changed to use the imported 'projects'
    ...
    if (selectedProject) {
      ...
      // You might want to redirect to a 404 page or display an error message.
      console.error(`Project with id ${id} not found`);
      navigate('/projects'); // Redirect to the projects page, or another appropriate route
    }
