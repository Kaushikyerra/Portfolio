...
const StatusBadge = memo(() => (
  <div
    className="inline-block animate-float lg:mx-0 w-full"
    data-aos="zoom-in"
    data-aos-delay="400"
  >
...
const CTAButton = memo(({ href, text, icon: Icon }) => (
  <a href={href} className="block">
    <button className="group relative w-[160px] ml-auto">
...
const WORDS = ["Web & Cloud Development", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/kaushikyerra" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/yerrakaushik" },
];
